    ...
    <div>
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li>
                ...
                <a href="{{ route('report') }}"
                    class="nav-link sub-nav-link d-flex align-items-center {{ request()->routeIs('report*') ? 'active' : '' }}">
        ...
        <header class="report-header animate">
            ...
            <div class="header-content d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-4">
                ...
                <div class="header-actions d-flex gap-2 no-print">
                    ...
                    <button
                        class="btn btn-premium btn-print"
                        ...
                        <div>
                            ...
                            <div class="stat-footer">
                                ...
                                <span class="trend-badge">
                                    ...
                                    {{ $total > 0
                                        ? number_format(
                                            (($starCounts[5] + $starCounts[4]) / $total) * 100,
                                            1
                                        )
                                        : 0
                                    }}%
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        @for($rating = 5; $rating >= 1; $rating--)
                            ...
                            <div class="rating-row {{ $rating == 1 ? 'mb-0' : '' }}">
                                ...
                                <div class="rating-progress">
                                    ...
                                    <div
                                        class="progress-bar bar-{{ $rating }}"
                                        style="width: {{ $total > 0 ? number_format(($starCounts[$rating] / $total) * 100, 1) : 0 }}%;">
                                    </div>
                                ...
                                <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
                                    ...
                                    <div class="review-actions">
                                        ...
                                        <form
                                            ...
                                            <button
                                                type="button"
                                                class="btn btn-sm btn-delete-review">
                                        ...
                                        @if($review->rating >= 4)
                                            ...
                                            <button
                                                type="button"
                                                class="btn btn-sm btn-reply-review"
                                                ...
                                                data-review-name="{{ $review->user_name ?: 'Anonymous' }}"

                                                data-existing-reply="{{ $review->admin_reply ?? '' }}">

                                                <i class="fa-solid fa-reply me-1"></i>

                                                {{ !empty($review->admin_reply)
                                                    ? 'Edit Reply'
                                                    : 'Reply'
                                                }}
                                            ...
                                            <div>
                                                ...
                                                <small>
                                                    ...
                                                    @if($review->replied_at)
                                                        ...
                                                        {{ \Carbon\Carbon::parse($review->replied_at)->format('d M Y H:i') }}
            ...
            <form
                ...
                <div class="modal-body p-4">
                    ...
                    <textarea
                        ...
                        placeholder="Write a friendly reply to your customer..."
                        required></textarea>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document
        ...
        .forEach(function (form) {
            ...
            const button =
                form.querySelector('.btn-delete-review');
...
const replyCustomerName =
    document.getElementById('replyCustomerName');

const replyTextarea =
    document.getElementById('admin_reply');


document
    .querySelectorAll('.btn-reply-review')
    .forEach(function (button) {
        ...
        button.addEventListener('click', function () {
            ...
            const customerName =
                this.dataset.reviewName;

            const existingReply =
                this.dataset.existingReply || '';


            replyCustomerName.textContent =
                customerName;
