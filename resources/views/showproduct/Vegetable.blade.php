...
<head>
    ...
    <style>
        ...
        * {
        ...
        [data-theme="dark"] .star-rating button i {
            color: #5b7466;
        }
        ...
        /* Card backgrounds — layered surfaces */
        ...
        [data-theme="dark"] .divide-slate-100 > * + * { border-color: rgba(125,212,154,.1) !important; }

        /* Shadows — chromatic glows */
        ...
        [data-theme="dark"] .border-dashed {
            border-color: rgba(125,212,154,.2) !important;
        }
        ...
        /* Review form text */
        [data-theme="dark"] #review-message {
            color: #8ba394 !important;
        }
