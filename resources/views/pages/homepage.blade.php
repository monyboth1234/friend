        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="mainNavbar">
                <ul class="navbar-nav ms-auto align-items-lg-center gap-lg-2">
                    ...
                    <li class="nav-item"><a href="{{ route('dashboard') }}" class="btn btn-primary me-2">Dashboard</a></li>
                     <li class="nav-item">
                    ...
                    <li class="nav-item ms-lg-2">
                        <form class="d-flex" role="search" action="{{ route('homepage') }}" method="GET">
    ...
    <div class="container py-5">
        ...
        @if($search !== '' && $allEmpty)
            <div class="text-center py-5">
                ...
                <a href="{{ route('homepage') }}" class="btn btn-outline-success rounded-5 px-4">Clear Search</a>
            </div>
        @else
            @if($search === '')
                <!-- Vegetables Section -->
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mt-2">
                                        ...
                                        <button
                                            ...
                                            onclick="goToProduct({{ $vegetable->id }}, 'vegetable')">
                                            Add to Cart
                                        </button>
                                    </div>
                                </div>
